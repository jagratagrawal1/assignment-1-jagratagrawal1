...
import definition.ContactAdd;
import definition.DeleteCon;
import definition.SearchCon;
import definition.ViewCon;
...
public class main {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Jagrat's Contact List");
